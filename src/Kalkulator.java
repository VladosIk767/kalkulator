...
public class Kalkulator implements ActionListener {
    ...
    Font myFont = new Font("11",Font.BOLD, 30);
    ...
    Kalkulator() {
        ...
        frame.setSize(427,470);
        frame.setLayout(null);

        textfield = new JTextField();
        textfield.setBounds(20,25,369,50);
        ...
        equButton.setBounds(329,255,60,144);
        delButton.setBounds(329,178,60,67);
        clrButton.setBounds(329,101, 60,67);
